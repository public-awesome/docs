...
Here is a quick and basic example which returns a subset of available data for a given `collectionAddr` and `tokenId` using the [`@apollo/client`](https://www.npmjs.com/package/@apollo/client) package.
